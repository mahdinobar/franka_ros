...
bool FrankaStateController::init(hardware_interface::RobotHW* robot_hardware,
  ...
  publisher_ee_pose_.init(controller_node_handle, "myfranka_ee_pose", 1);
  {
...
void FrankaStateController::publishmyFrankaStates(const ros::Time& time) {
  if (publisher_ee_pose_.trylock()) {
